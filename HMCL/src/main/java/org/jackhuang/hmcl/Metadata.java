...
public final class Metadata {
    ...
    public static final String NAME = "DreamCraft-Tech";
    public static final String FULL_NAME = "DreamCraft Railway Launcher";
    ...
    public static final String FULL_TITLE = FULL_NAME + " V2.0.0";
